  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        showAlert(
          data.error ||
            "Something went wrong. Failed to reset your password. Please try again later.",
          "error"
        );
      } else {
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Reset password of your Carikopi account"
        />
      </Head>
      ...
      >
        ...
        >
          ...
          <Typography variant="body2" textAlign="center" mb={3}>
            Your password must be at least 5 characters and should include a
